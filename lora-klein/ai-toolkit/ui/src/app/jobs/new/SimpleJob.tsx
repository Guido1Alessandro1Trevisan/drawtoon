            ...
            <div className={trainingBarClass}>
              <div>
                ...
                <NumberInput
                  ...
                  className="pt-2"
                  value={jobConfig.config.process[0].train.gradient_accumulation_steps}
                  onChange={value => setJobConfig(value, 'config.process[0].train.gradient_accumulation_steps')}
                  placeholder="eg. 1"
                  min={1}
                  required
                />
