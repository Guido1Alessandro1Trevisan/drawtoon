...
Distributed Magi v3 annotation for Drawtoon manga pages. 40 H100s in parallel,
...
- **`--gpu-batch-size 8`** — empirical sweet-spot on H100. Magi v3 hard-resizes
...
└── modal_magi.py        # Modal app: H100 class with @modal.enter snapshotting
```
